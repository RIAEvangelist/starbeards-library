import waitForComponent from './WaitForComponent.js?arcaneVersion=0.5.17';
...
async function sendWithWindowMail(target,...args){
    if(typeof target?.mail?.send!=='function'){
        await import('./Mail.js?arcaneVersion=0.5.17');
    }
...
async function ensureHTMLImport(target){
    ...
    try{
        await import('./HTMLImport.js?arcaneVersion=0.5.17');
    }catch(error){
        if(!registry.get('html-import')){
            throw error;
        }
