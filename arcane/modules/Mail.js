...
import MailOutbox from './MailOutbox.mjs?arcaneVersion=0.28.4';
import {
    sendMailReport,
...
async function loadRequiredMailStorage(){
    try{
        await import('./DBOPFS.js?arcaneVersion=0.28.4');
    }catch{
        throw codedError(
...
async function resolveMailUserEntity(injectedUser){
    ...
    const {default:UserEntity}=await import('../entities/User.js?arcaneVersion=0.28.4');
