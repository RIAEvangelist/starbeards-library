...
import MailOutbox from './MailOutbox.mjs?arcaneVersion=0.28.2';
import {
    sendMailReport,
} from './MailTransport.mjs?arcaneVersion=0.28.2';
...
async function loadRequiredMailStorage(){
    try{
        await import('./DBOPFS.js?arcaneVersion=0.28.2');
    }catch{
        throw codedError(
...
async function resolveMailUserEntity(injectedUser){
    ...
    const {default:UserEntity}=await import('../entities/User.js?arcaneVersion=0.28.2');
