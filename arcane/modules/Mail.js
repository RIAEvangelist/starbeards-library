...
import MailOutbox from './MailOutbox.mjs?arcaneVersion=0.28.3';
import {
    sendMailReport,
...
async function loadRequiredMailStorage(){
    try{
        await import('./DBOPFS.js?arcaneVersion=0.28.3');
    }catch{
        throw codedError(
...
async function resolveMailUserEntity(injectedUser){
    ...
    const {default:UserEntity}=await import('../entities/User.js?arcaneVersion=0.28.3');
