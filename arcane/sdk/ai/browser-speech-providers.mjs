...
} from "./browser-speech-artifacts.mjs?arcaneVersion=0.5.18";
import { stripSpeechFormatting } from "../speech-text.mjs?arcaneVersion=0.5.18";
...
} from "./speech-worker-client.mjs?arcaneVersion=0.5.18";
