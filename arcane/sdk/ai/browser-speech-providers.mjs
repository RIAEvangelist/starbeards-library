...
} from "./browser-speech-artifacts.mjs?arcaneVersion=0.27.1";
import { stripSpeechFormatting } from "../speech-text.mjs?arcaneVersion=0.27.1";
...
} from "./speech-worker-client.mjs?arcaneVersion=0.27.1";
