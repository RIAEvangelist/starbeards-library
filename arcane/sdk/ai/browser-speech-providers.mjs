...
} from "./browser-speech-artifacts.mjs?arcaneVersion=0.28.2";
import { stripSpeechFormatting } from "../speech-text.mjs?arcaneVersion=0.28.2";
...
} from "./speech-worker-client.mjs?arcaneVersion=0.28.2";
