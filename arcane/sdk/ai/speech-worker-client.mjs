...
} from "./speech-worker-runtime.mjs?arcaneVersion=0.27.0";
...
class SpeechWorkerClient {
  ...
  constructor({ role, onTermination = () => undefined } = {}) {
    ...
    const workerUrl = role === "stt"
      ? new URL("./browser-whisper-worker.mjs?arcaneVersion=0.27.0", import.meta.url)
      : new URL("./browser-kokoro-worker.mjs?arcaneVersion=0.27.0", import.meta.url);
    this.#role = role;
