...
import {Wllama, WllamaRuntimeError} from './wllama/index.mjs?arcaneVersion=0.25.0';

const is = new Is(false);

const completeValue = (value) => value;

const MODULE_URL = new URL("./wllama/index.mjs?arcaneVersion=0.25.0", import.meta.url).href;
const WASM_URL = new URL("./wllama/wllama.wasm?arcaneVersion=0.25.0", import.meta.url).href;
